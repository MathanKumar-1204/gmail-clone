...
const Inbox: React.FC<InboxProps> = ({ searchQuery }) => {
  ...
  const [activeTab, setActiveTab] = useState("Primary"); // Default category

  useEffect(() => {
    if (typeof window !== "undefined") {
      const searchParams = new URLSearchParams(window.location.search);
      setActiveTab(searchParams.get("category") || "Primary");
    }
  }, []);
  ...
  const mockEmails: Email[] = [
    {
      ...
      snippet: "This is your Gmail clone",
      sender: "Google",
      date: "Today",
      unread: true,
      starred: false,
      body: "Welcome to your new Gmail clone. Here are some tips to get started...",
      category: "Primary",
    },
    {
      id: 2,
      subject: "React Project",
      snippet: "Let’s work on the React project",
      sender: "John",
      date: "Yesterday",
      unread: false,
      starred: true,
      body: "Hi, let’s collaborate on the React project. Here’s what we need to do...",
      category: "Primary",
    },
    {
      id: 3,
      subject: "Tailwind CSS Tips",
      snippet: "Learn Tailwind CSS quickly",
      sender: "Tailwind Team",
      date: "2 Days Ago",
      unread: false,
      starred: false,
      body: "Tailwind CSS is a utility-first framework. Here are some tips and tricks...",
      category: "Promotions",
    },
    {
      id: 4,
      subject: "New social platform",
      snippet: "Join our new platform!",
      sender: "Social Team",
      date: "3 Days Ago",
      unread: false,
      starred: false,
      body: "Connect with others on our new platform...",
      category: "Social",
    },
  ];
  ...
  const handleTabClick = (tab: string) => {
    ...
    setActiveTab(tab); // Update state to reflect UI change instantly
  };
  ...
  return (
    <div className="flex-1 p-4">
      ...
      {selectedEmail ? (
        ...
        <div>
          <button className="mb-4 text-blue-500" onClick={handleBackToInbox}>
            Back to Inbox
          </button>
          <div className="p-4 border rounded shadow-lg bg-white">
            <div className="flex justify-between items-center">
              ...
              <div>
                {selectedEmail.starred ? <FaStar className="text-yellow-400" /> : <FaRegStar className="text-gray-400" />}
              </div>
            </div>
            <div className="mt-4">
          ...
          {filteredEmails.map((email) => (
            <div
              ...
              className={`flex justify-between items-center p-4 border-b hover:bg-gray-50 cursor-pointer ${
                email.unread ? "font-bold bg-gray-100" : ""
              }`}
