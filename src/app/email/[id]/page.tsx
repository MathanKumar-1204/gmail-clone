  ...
  const renderContent = () => {
    switch (selectedRoute) {
      ...
      case 'spam':
        return <Spam />;
      default:
        return <Inbox searchQuery={searchQuery} selectedTab={selectedTab} />; 
    }
  };
  ...
  return (
    <div className="flex h-screen">
      ...
      <Header 
          ...
          selectedTab={selectedTab}         // Pass the currently selected tab
          setSelectedTab={setSelectedTab}   // Function to update selected tab
        />
